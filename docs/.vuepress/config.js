...
module.exports = {
  ...
  themeConfig: {
    ...
    repo: 'https://github.com/gengbingbing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '腾宇', // 必需
      link: 'https://github.com/gengbingbing', // 可选的
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-csdn',
          title: 'CSDN',
          link: 'https://blog.csdn.net/qq_23334071?type=blog',
        },
        {
          iconClass: 'icon-youjian',
          title: '发邮件',
          link: 'mailto:gengbingbing628@gmail.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
